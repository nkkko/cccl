...
_LIBCUDACXX_CONCEPT resource_with = _LIBCUDACXX_REQUIRES_EXPR((_Resource, variadic _Properties))(
...
// We cannot use fold expressions here due to a nvcc bug
template <class _Resource, class... _Properties>
_LIBCUDACXX_CONCEPT async_resource_with = _LIBCUDACXX_REQUIRES_EXPR((_Resource, variadic _Properties))(
