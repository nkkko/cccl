...
template <class _Tp>
_LIBCUDACXX_CONCEPT __has_member_get_execution_policy = _LIBCUDACXX_REQUIRES_EXPR((_Tp), const _Tp& __t)(
  requires(_CCCL_TRAIT(_CUDA_VSTD::is_convertible, decltype(__t.get_execution_policy()), execution_policy)));

template <class _Env>
_LIBCUDACXX_CONCEPT __has_query_get_execution_policy = _LIBCUDACXX_REQUIRES_EXPR((_Env))(
