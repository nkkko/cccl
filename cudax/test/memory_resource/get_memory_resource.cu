...
using device_resource = cuda::experimental::mr::device_memory_resource;
...
{
  ::cuda::mr::device_memory_resource res_{};

  ::cuda::mr::device_memory_resource get_resource() noexcept
  {
    return res_;
  }
};
