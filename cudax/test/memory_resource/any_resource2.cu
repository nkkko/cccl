...
#  include <cuda/experimental/__memory_resource/any_resource2.cuh>
...
static_assert(
  cuda::has_property<cudax::mr::any_resource2<cuda::mr::host_accessible, get_data>, cuda::mr::host_accessible>);
static_assert(cuda::has_property<cudax::mr::any_resource2<cuda::mr::host_accessible, get_data>, get_data>);
static_assert(
  !cuda::has_property<cudax::mr::any_resource2<cuda::mr::host_accessible, get_data>, cuda::mr::device_accessible>);

TEMPLATE_TEST_CASE_METHOD(test_fixture, "any_resource2", "[container][resource]", big_resource, small_resource)
{
  ...
  SECTION("construct and destruct")
  {
    ...
    {
      cudax::mr::any_resource2<cuda::mr::host_accessible, get_data> mr{TestResource{42, this}};
  ...
  SECTION("conversion from any_resource2 to resource_ref2")
  {
    Counts expected{};
    {
      cudax::mr::any_resource2<cuda::mr::host_accessible, get_data> mr{TestResource{42, this}};
      ...
      cudax::mr::resource_ref2<cuda::mr::host_accessible, get_data> ref = mr;
  ...
  SECTION("conversion from resource_ref2 to any_resource2")
  {
    Counts expected{};
    {
      TestResource test{42, this};
      ++expected.object_count;
      cudax::mr::resource_ref2<cuda::mr::host_accessible, get_data> ref{test};
      CHECK(this->counts == expected);

      cudax::mr::any_resource2<cuda::mr::host_accessible, get_data> mr = ref;
      expected.new_count += is_big;
      ++expected.object_count;
      ++expected.copy_count;
      CHECK(this->counts == expected);
  ...
  SECTION("test slicing off of properties")
  {
    ...
    CHECK(this->counts == expected);
    {
      ...
      cudax::mr::any_resource2<get_data> mr2 = mr;
      expected.new_count += is_big;
      ++expected.object_count;
      ++expected.copy_count;
      CHECK(this->counts == expected);
  ...
  SECTION("make_any_resource2")
  {
    Counts expected{};
    CHECK(this->counts == expected);
    {
      cudax::mr::any_resource2<cuda::mr::host_accessible, get_data> mr =
        cudax::mr::make_any_resource2<TestResource, cuda::mr::host_accessible, get_data>(42, this);
      expected.new_count += is_big;
      ++expected.object_count;
      CHECK(this->counts == expected);
    }
