...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__has_member_get_resource_,
                             requires(const _Tp& __t)(requires(
                               _CUDA_VMR::async_resource<cuda::std::remove_cvref_t<decltype(__t.get_resource())>>)));

template <class _Tp>
_LIBCUDACXX_CONCEPT __has_member_get_resource = _LIBCUDACXX_FRAGMENT(__has_member_get_resource_, _Tp);

struct get_memory_resource_t;

template <class _Env>
_LIBCUDACXX_CONCEPT_FRAGMENT(
  __has_query_get_memory_resource_,
...
template <class _Env>
_LIBCUDACXX_CONCEPT __has_query_get_memory_resource = _LIBCUDACXX_FRAGMENT(__has_query_get_memory_resource_, _Env);
...
struct get_memory_resource_t
{
  ...
  _LIBCUDACXX_REQUIRES(__has_member_get_resource<_Tp>)
  ...
  _LIBCUDACXX_TEMPLATE(class _Env)
  _LIBCUDACXX_REQUIRES(__has_query_get_memory_resource<_Env>)
