...
template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__has_member_get_execution_policy_,
...
template <class _Tp>
_LIBCUDACXX_CONCEPT __has_member_get_execution_policy = _LIBCUDACXX_FRAGMENT(__has_member_get_execution_policy_, _Tp);
...
template <class _Env>
_LIBCUDACXX_CONCEPT __has_query_get_execution_policy = _LIBCUDACXX_FRAGMENT(__has_query_get_execution_policy_, _Env);

struct get_execution_policy_t
{
  _LIBCUDACXX_TEMPLATE(class _Tp)
  _LIBCUDACXX_REQUIRES(__has_member_get_execution_policy<_Tp>)
  ...
  _LIBCUDACXX_REQUIRES(__has_query_get_execution_policy<_Env>)
