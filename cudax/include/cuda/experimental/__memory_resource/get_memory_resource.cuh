...
template <class _Tp>
_LIBCUDACXX_CONCEPT __has_member_get_resource = _LIBCUDACXX_REQUIRES_EXPR((_Tp), const _Tp& __t)(
  requires(_CUDA_VMR::async_resource<cuda::std::remove_cvref_t<decltype(__t.get_resource())>>));

template <class _Env>
_LIBCUDACXX_CONCEPT __has_query_get_memory_resource = _LIBCUDACXX_REQUIRES_EXPR((_Env))(
